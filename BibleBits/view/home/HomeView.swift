...
struct HomeView: View {
        ...
        NavigationStack {
                ...
                if homeViewModel.isRefreshing || bibleService.loading {
                    ...
                    LazyVStack(alignment: .leading) {
                        if !homeViewModel.showingEntireChapter {
                            ...
                            .font(
                                .system(
                                    size: fontSize, weight: .regular, design: fontFamily.fontDesign)
                            )
            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .bottomBar) {
                    ...
                    Button(
                        "", systemImage: homeViewModel.isPassageSaved ? "bookmark.fill" : "bookmark"
                    ) {
    ...
    func savePassage(
        homeViewModel: HomeViewModel, modelContext: ModelContext, dismiss: DismissAction
    ) {
        guard let devotional = homeViewModel.randomDevotional else {
            return
        }
